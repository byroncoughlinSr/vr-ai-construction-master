...
async def test_long_prompt():
    ...
    prompt = """SUBJECT: outdoor dog house structure,
    small-scale pet shelter architecture,
    residential backyard pet house,
    STYLE: modern craftsman residential architecture adapted for dogs,
    southern california backyard design aesthetic,
    clean professional construction quality,
    compact proportional design for medium to large dogs,
    CONTEXT: placed in backyard setting,
    appropriate scale relative to surrounding landscaping,
    clearly a pet structure not human dwelling,
    ...
    EMPHASIS: small scale pet house structure,
    dog-sized entrance and proportions,
    visible size reference like nearby plants or fence"""
...
async def test_voice_to_image():
    ...
    with a 30 degree pitched roof, shingle dark brown"""
